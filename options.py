...
def get_parser():
    ...
    parser.add_argument('--pn_use_bn', type=bool, default=False, help='using batch normalization for pointnet (not cond-bn-pointnet)')
    parser.add_argument('--cond_pn', type=bool, default=False, help='whether to use conditional pointnet')
    parser.add_argument('--use_dist_hit', type=bool, default=False, help='predict hit distance as an auxiliary loss, run cal_hit_dist.py first')
    parser.add_argument('--tfm_pos_enc', type=bool, default=False, help='using transformer postisitonal encoding')
    ...
    parser.add_argument('--norm_coord', type=bool, default=True, help='normalize the coordninates(modulus transformed into 1) before feeding them into networks')
